...
public struct GetRecentArticlesQuery: GraphQLQuery {
  public static let operationName: String = "GetRecentArticles"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetRecentArticles($amount: Int!) { recentArticle(amount: $amount) { __typename ...ArticleFields ...ArticleWithLinks } }"#,
  ...
  public struct Data: Graphql.SelectionSet {
    ...
    @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
      .field("recentArticle", [RecentArticle?].self, arguments: ["amount": .variable("amount")]),
    ] }
    @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
      GetRecentArticlesQuery.Data.self
    ] }

    public var recentArticle: [RecentArticle?] { __data["recentArticle"] }
    ...
    public init(
      ...
      self.init(unsafelyWithData: [
        ...
        "recentArticle": recentArticle._fieldData,
      ])
    }
    ...
    ///
    /// Parent Type: `Article`
    public struct RecentArticle: Graphql.SelectionSet {
      @_spi(Unsafe) public let __data: DataDict
      @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GetRecentArticlesQuery.Data.RecentArticle.self,
        ArticleFields.self,
