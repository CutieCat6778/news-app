...
public struct GetArticlesQuery: GraphQLQuery {
  public static let operationName: String = "GetArticles"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetArticles { articles { __typename ...ArticleFields } }"#,
  ...
  public struct Data: Graphql.SelectionSet {
    ...
    public struct Article: Graphql.SelectionSet {
      ...
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GetArticlesQuery.Data.Article.self,
        ArticleFields.self
      ] }
