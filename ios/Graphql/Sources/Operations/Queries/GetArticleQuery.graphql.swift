...
public struct GetArticleQuery: GraphQLQuery {
  public static let operationName: String = "GetArticle"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetArticle($id: ID!) { article(id: $id) { __typename ...ArticleFields ...ArticleWithLinks } }"#,
  ...
  public struct Data: Graphql.SelectionSet {
    ...
    public struct Article: Graphql.SelectionSet {
      ...
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GetArticleQuery.Data.Article.self,
        ArticleFields.self,
